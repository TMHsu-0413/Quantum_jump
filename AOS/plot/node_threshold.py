...
class ChartGenerator:
    ...
    def __init__(self, dataName, Ylabel, Xlabel):
       ...
       ##data start##
        ...
        plt.savefig(directory_path + 'different_threshold_5_nodes.eps'.format(pdfName)) 
        plt.savefig(directory_path2 + 'different_threshold_5_nodes.jpg'.format(pdfName)) 
...
if __name__ == "__main__":
    ...
    for Xlabel in Xlabels:
        for Ylabel in Ylabels:
            dataFileName = 'node_threshold.ans'
