...
class ChartGenerator:
    ...
    def __init__(self, dataName, Ylabel, Xlabel):
        ...
        plt.savefig(directory_path + 'answer_rate_on_0.8th.eps'.format(pdfName)) 
        plt.savefig(directory_path2 + 'answer_rate_on_0.8th.jpg'.format(pdfName)) 
