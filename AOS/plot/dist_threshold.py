...
class ChartGenerator:
    ...
    def __init__(self, dataName, Ylabel, Xlabel):
       ...
       ##data start##
        ...
        plt.savefig(directory_path + 'avg_entangle_dis.eps'.format(pdfName)) 
        plt.savefig(directory_path2 + 'avg_entangle_dis.jpg'.format(pdfName)) 
...
if __name__ == "__main__":
    ...
    for Xlabel in Xlabels:
        for Ylabel in Ylabels:
            dataFileName = 'dist_threshold.ans'
